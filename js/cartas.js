...
let contPartJugadas = 0;//cuenta la cantidad de partidas jugadas
...
function comenzar(){//Esta funcion vacía el vector que me imdica cuales son las cartas elegidas
...
function guardarCartas() {
	...
	console.log("5-" + arreglo_cartasMin[4] + " 6-" );
}
...
function elegirCarta(nCarta){
	...
	if (arreglo_elegidas[nCarta]=="0"){//Compruebo si la carta seleccionada ya fue elegida
		...
		if (arreglo_cartasMin[nCarta]=="B"){//En caso de ser una Bomba
			...
			contPartJugadas ++;
			console.log ("-contPartJugadas:" + contPartJugadas);
			if(multiple(contPartJugadas,2)){
				mezclar();
			}
			else
			{
